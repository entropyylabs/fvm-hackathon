...
const ContributionPageDupes = () => {
  return (
    <div className={styles.contributionPageDupes}>
      <div className={styles.contributionPageDupesInner}>
        <div className={styles.frameParent}>
          ...
          <div className={styles.rectangleParent1}>
            <div className={styles.frameItem} />
            <div className={styles.frameChild} />
            <img className={styles.flagIcon1} alt="" src="../flag.svg" />
            <div className={styles.byJohnDoe}>by John Doe</div>
            <Button
              className={styles.buttonsolidTextAndIcon1}
              variant="solid"
          ...
          <div className={styles.claimContributionsTo}>
      ...
      <nav className={styles.lightLogoLeft5LinksCeParent}>
        ...
        <img className={styles.frameChild20} alt="" src="../frame-44.svg" />
      </nav>
    </div>
  );
};
